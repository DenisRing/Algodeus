#This file is heavily based on Daniel Johnson's midi manipulation code and a wrapper built by YJH1987
...
songs = get_songs('Mozart_Samples') 
...
# Variables for weight, matrix, bias vectors etc
